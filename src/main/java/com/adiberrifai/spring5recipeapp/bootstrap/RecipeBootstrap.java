package com.adiberrifai.spring5recipeapp.bootstrap;

import com.adiberrifai.spring5recipeapp.domain.*;
import com.adiberrifai.spring5recipeapp.repositories.CategoryRepository;
import com.adiberrifai.spring5recipeapp.repositories.RecipeRepository;
import com.adiberrifai.spring5recipeapp.repositories.UnitOfMeasureRepository;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public void onApplicationEvent(ContextRefreshedEvent event) {
        log.debug("init. recipe bootstrap");
